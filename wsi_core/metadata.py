    ...
    def _build_path_suffixes() -> Dict:
        ...
        for i in range(1, 12):
            if i in range(1, 9):
                ...
                batches = '9-11'
            path_suffixes[f'{constants.dataset_id_carmel}{i}'] = f'Breast/{constants.dataset_id_carmel.capitalize()}/{batches}/Batch_{i}/{constants.dataset_id_carmel}{i}'

        for i in range(2, 7):
            path_suffixes[f'{constants.dataset_id_sheba}{i}'] = f'Breast/{constants.dataset_id_sheba.capitalize()}/{batches}/Batch_{i}/{constants.dataset_id_sheba}{i}'
