...
def cli_main(args: ArgsType = None):
    ...
    cli = WsiLightningCLI(  # noqa: F841
        ...
        parser_kwargs={
            "fit": {"default_config_files": ["configs/regressor/default_config_fit.yaml"]},
            "test": {"default_config_files": ["configs/regressor/default_config_test.yaml"]},
            "predict": {
                "default_config_files": ["configs/regressor/default_config_predict.yaml"]
            },
        },
