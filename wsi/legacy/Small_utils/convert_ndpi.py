...
if os.path.isdir(r'E:\ABCTB') and os.path.isdir(r'D:\ABCTB_TIFF'):
    REMOVABLE = True
...
if sys.platform == 'darwin':
    ...
    original_path = r'E:\ABCTB\Batch1'
    slide_data_filename = r'slides_data_ABCTB_conversion.xlsx'
    #new_slides_path = r'E:\ABCTB_TIFF\Batch1'
    #new_slides_path = r'C:\temp'
    new_slides_path = r'D:\ABCTB_TIFF\Batch1'
...
def convert_1_slide(slide_name, batch: str = ''):
    ...
    tif_thumb_filename_png = os.path.join(new_slides_path, 'TIF_Thumbs', slide_basic_name + '_thumb.jpg')
    ...
    tmb.save(os.path.join(new_slides_path, 'TIF_Thumbs', slide_basic_name + '_thumb_ndpi.jpg'))
