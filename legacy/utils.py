...
def map_colors(patches, rate = 1):
    map_file = './color_map_EGA2Carmel.csv'
    ...
    if experiment is not None:
        if sys.platform == 'linux':
            if 0 < int(experiment) < 10000:
                ...
                user_name = 'Tal'
                run_file_name = r'/home/talneoran/workspace/wsi/legacy/runs/run_data.xlsx'
                location_prefix = '/home/talneoran/workspace/wsi/legacy'
                ...
                user_name = 'Shachar'
                run_file_name = r'/home/shacharcohen/workspace/WSI/legacy/runs/run_data.xlsx'
                location_prefix = '/home/shacharcohen/workspace/WSI/legacy'
        else:
            user_name = None
...
def assert_dataset_target(DataSet, target_kind):
    ...
    if DataSet == 'TMA_HE_01_011' and not target_kind <= {'binary_live', 'ER'}:
    ...
    elif (DataSet in ['TCGA', 'CAT', 'ABCTB_TCGA', 'ABCTB', 'CARMEL_ABCTB', 'EGA']) and not target_kind <= {'ER', 'PR', 'Her2', 'OR', 'is_cancer',
                                                                            'Ki67', 'EVERYTHING'}:
        raise ValueError('target should be one of: ER, PR, Her2, OR, is_cancer, Ki67, EVERYTHING')
        ...
        raise ValueError('target should be: RedSquares')
                                                    ...
                                                    'onco_score_31', 'onco_score_all', 'ER'}:
...
def send_run_data_via_mail():
    ...
    if 'womer' in path_parts:
        ...
        filename = '/home/talneoran/workspace/wsi/legacy/runs/run_data.xlsx'
        user = 'talneoran'
        ...
        filename = '/home/shacharcohen/workspace/WSI/legacy/runs/run_data.xlsx'
        user = 'Shachar'
