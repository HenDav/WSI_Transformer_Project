...
class MilTransformerModule(LightningModule):
    ...
    def test_step(self, batch, batch_idx):
        ...
        # TODO: testing currently only supports feature files and not on-the-fly feature extraction
        ...
        for _ in range(self.hparams.test_repeats):
            ...
            for bag, patch_positions in bag_loader:
                ...
                # get scores for positive class (currently only for binary classification)
    ...
    def shared_step(self, batch):
        if self.feature_extractor_model is not None:
            ...
            # TODO: return patch locations in MIL dataset like in inference dataset and use them here
            # TODO: temp workaround for above, check if this is correct
    ...
    def add_model_specific_args(parent_parser):
        ...
        #                     default='preact',
        #                     help='type of feature extractor model')
        parser.add_argument(
            "--input_dim",
            type=int,
            default=512,
