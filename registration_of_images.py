...
def interpolate_image(img2, grid_x, grid_y):
	...
	R_interpolated = griddata(points=points, values=values_R, xi=(grid_y, grid_x), fill_value=5, method='linear')
...
def draw_points(img, points):
	for p in points:
		p = (int(p[1]), int(p[0]))
		cv2.circle(img, center=p, radius=15, color=(0, 0, 255), thickness=-1)
...
if __name__=="__main__":
	...
	HE_cord = [(324, 217), (306, 324), (268, 383), (239, 404), (209, 369), (409, 500), (428, 532), (407, 587), (366, 569),
	...
	'''file1 = '/Users/wasserman/Downloads/Dog'
	file2 = '/Users/wasserman/Downloads/Dog'
	...
	'''
	# FLOWER
	HE_cord = [(429, 847), (443, 2098), (1461, 2842), (2224, 2261), (2185, 691)]
	IHC_cord = [(1794, 730), (670, 741), (413, 1778), (895, 2837), (1959, 2770)]
	'''
	...
	#rect_HE = (0, 0, img1.shape[0], img1.shape[1])
	#rect_IHC = (0, 0, img2.shape[0], img2.shape[1])
	...
	if False:
		...
		HE_cord, IHC_cord = fix_coordinates(coordinates_Left, img1, img2)
		print(HE_cord)
		print(IHC_cord)
	...
	new_coord = apply_points_transform(points=[HE_cord[HE_tri.simplices[0][0]], HE_cord[HE_tri.simplices[0][1]], HE_cord[HE_tri.simplices[0][2]]], transform=transform_matrices[0])

	draw_points(img2, new_coord)
